...
def run(repo_root: Path) -> int:
    template_path = repo_root / "skills" / "novel-coauthoring-standard" / "evals" / "multi-book-stress-template.yaml"
    metrics_path = repo_root / "skills" / "novel-coauthoring-standard-workspace" / "iteration-4" / "perf-raw-metrics-v1.jsonl"
    report_path = repo_root / "skills" / "novel-coauthoring-standard-workspace" / "iteration-4" / "perf-baseline-v1.md"
